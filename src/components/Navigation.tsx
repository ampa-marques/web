          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex justify-between items-center border-b-2 border-gray-100 py-3 md:justify-start md:space-x-10">
              ...
              <Popover.Group as="nav" className="hidden md:flex space-x-10">
                ...
                {menu.map(page => (
                  <Link href={`/${page.slug}`} as={page.slug}>
                    <a href={`/${page.slug}`} className="text-base font-medium text-gray-500 hover:text-gray-900" key={page.slug}>
                      {page.name}
                    </a>
                  </Link>
                ...
                <div className="pt-5 pb-6 px-5">
                  ...
                  <div className="mt-6">
                    <nav className="grid gap-y-8">
                      ...
                      {menu.map((item) => (
                        <Link href={`/${item.slug}`} as={item.slug} key={item.name}>
